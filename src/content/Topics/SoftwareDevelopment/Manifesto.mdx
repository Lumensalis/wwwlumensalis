...
complex systems.   It is by no means an exhaustive list.  It still have 
a bit of [editing](#short-is-sweet) left to do.  But it offers some insight 
into my perspective on what matters for developing software.
...
There are many ways to improve the readability of your code, some of which is
...
reasonable often valuable principles to employ in the design/development cycle. 
...
you, Y2K and Y2K era Java "Enterprise" apps...).   I came across it when
 researching the origin of the  Which is a shame, because
what little I've seen so far has quite a lot of a _lot_ of parallels with the driving looks _very_
